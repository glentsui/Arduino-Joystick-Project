...
void draw() {
  if (!gameOver) {
    ...
    {  // If data is available,
      ...
      if (val!=null && val.contains("left") && (snakeLastMov != RIGHT)) {
        snakeMov = LEFT;
        println("left");
      } else if (val!=null && val.contains("right")&& (snakeLastMov != LEFT)) {
        println("right");
        snakeMov = RIGHT;
      } else if (val!=null && val.contains("up")&& (snakeLastMov != DOWN)) {
        println("up");
        snakeMov = UP;
      } else if (val!=null && val.contains("down")&& (snakeLastMov != UP)) {
        println("down");
        snakeMov = DOWN;
      }
    }
